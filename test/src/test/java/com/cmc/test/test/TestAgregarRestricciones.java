...
public class TestAgregarRestricciones {
	public static void main(String[] args) {
		ServicioRestricciones servicio = new ServicioRestricciones();
		int[] placasLunes = { 1, 2 };
		int[] placasMartes = { 3, 4 };
		int[] placasMiercoles = { 5, 6 };
		int[] placasJueves = { 7, 8 };
		int[] placasViernes = { 9, 0 };
		LocalDate lunesDia = LocalDate.of(2022, 8, 15);
		LocalDate martesDia = LocalDate.of(2022, 8, 16);
		LocalDate miercolesDia = LocalDate.of(2022, 8, 17);
		LocalDate juevesDia = LocalDate.of(2022, 8, 18);
		LocalDate viernesDia = LocalDate.of(2022, 8, 19);
		...
		ArrayList<Restriccion> resultado = servicio.getRestricciones();
